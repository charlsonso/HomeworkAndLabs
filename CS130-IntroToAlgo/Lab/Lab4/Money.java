...
public class Money
{
   ...
   */
   ...
   // Charlson So 3/22/2017
   //@param money object with filled dollars and cents

   public Money(Money d){
      dollars = d.dollars;
      cents = d.cents;
   }

   public boolean equals(Money d){
      return ((dollars==d.dollars)&&(cents==d.cents))?true:false;
   }
   ...
   public String toString(){
      ...
      if (dollars==0){
        ...
        temp+=Long.valueOf(dollars);
        temp+=".";
      }
      if (cents<10){
        temp+="0";
        temp+=Long.valueOf(cents);
      }
      else{
        temp+=Long.valueOf(cents);
      }
